  ...
  return (
    <div className={clsx("relative", wrapperClassName)}>
      <div
        ...
        className={clsx(
          "p-3 text-sm rounded-lg whitespace-pre-wrap w-full text-white/80 transition-all bg-white/[0.03] outline-none focus:outline-none overflow-auto break-words",
          className
        )}
        {...props}
      ></div>
