---
title: fileToGenerativePart()
---

import FileToGenerativePartExample from "./example/FileToGenerativePartExample"
...
```ts title="fileToGenerativePart.ts"
